...
//add_action( 'woocommerce_before_shop_loop', 'woocommerce_slider_and_categories', 0 );
...
add_action( 'woocommerce_single_product_summary', 'woocommerce_show_product_images', 8 );
