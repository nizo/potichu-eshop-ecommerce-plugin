...
class WC_Emails {
	...
	function init() {
		...
		$this->emails['WC_Email_Customer_Money_Received']   = include( 'emails/class-wc-email-customer-money-received.php' );
		$this->emails['WC_Email_Customer_Canceled_Order']   = include( 'emails/class-wc-email-customer-canceled-order.php' );
		$this->emails['WC_Email_Customer_Order_Ready']   = include( 'emails/class-wc-email-customer-order-ready.php' );
