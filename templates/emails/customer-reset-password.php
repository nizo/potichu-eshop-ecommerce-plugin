...
<p><?php _e( 'Someone requested that the password be reset for the following account:', 'woocommerce' ); ?>
<?php echo '<br/>Email: ' . $user_email; ?></p>
<p>
<?php _e( 'If this was a mistake, just ignore this email and nothing will happen.', 'woocommerce' ); 
echo ' ';
_e( 'To reset your password, visit the following address:', 'woocommerce' ); ?></p>
<p>
