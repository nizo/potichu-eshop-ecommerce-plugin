			...
			if ( wc_get_page_id( 'terms' ) > 0 && apply_filters( 'woocommerce_checkout_show_terms', true ) ) { 
				...
				<p class="form-row terms">					
					...
					<div class="terms-of-use">
						<?php /*<input type="checkbox" class="input-checkbox" name="terms" <?php checked( $terms_is_checked, true ); ?> id="terms" /> */?>
						<input type="checkbox" class="input-checkbox" name="terms" checked id="terms" style="display: none;"/>
